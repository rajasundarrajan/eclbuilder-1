...
! function(a) {
    ...
    w.updateTextArea = function(aId, uuid){
    	uidComp = document.getElementById(uuid);
    	comp = aId;
    	...
    	if(null != a.nextSibling){
    		...
    		var sparArr = a.nextSibling.getElementsByTagName("span");
    		
    		for (var i = 0; i < sparArr.length; i++) {
    			if(sparArr[i].className == "" && sparArr[i].innerText.length > 1){
    			newValues = newValues + sparArr[i].innerText + "\n";
    			}
    		}
    	}
    	comp.value = newValues;
    };
...
//    	oldCode.value = a.value;
    	...
    	if(null != a.nextSibling){
    		...
    		for (var i = 0; i < sparArr.length; i++) {
    			if(undefined != typeof sparArr[i] && "undefined" != sparArr[i] && sparArr[i].className == "" && sparArr[i].innerText.length > 1){
    			newValues = newValues + sparArr[i].innerText.trim().replace("\n", "") + "\n";
    			}
    		}
    	}
